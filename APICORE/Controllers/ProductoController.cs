        ...
        public IActionResult Obtener(int idProducto)
        {
            ...
            try
            {
                using (var conexion = new SqlConnection(cadenaSQL))
                {
                    ...
                    return StatusCode(StatusCodes.Status200OK, new { mensaje = "ok", objeto = producto });
                }

            }
            catch (Exception error)
            {
                return StatusCode(StatusCodes.Status500InternalServerError, new { mensaje = error.Message, objeto = lista });
            }
        }
        ...
        public IActionResult Eliminar(int idProducto)
        {
            try
            {
                using (var conexion = new SqlConnection(cadenaSQL))
                {
                    ...
                    return StatusCode(StatusCodes.Status200OK, new { mensaje = "ELEMENTO ELIMINADO" });
                }
